    ...
    <>
      <div className="min-h-screen bg-black text-white font-sans">
        ...
        <main className="relative">
            ...
            <div className="absolute inset-0 z-20 flex items-end">
              <div className="max-w-3xl p-8 md:p-12 lg:p-20">
                ...
                <p className="text-gray-200 max-w-xl mb-6 leading-relaxed">
                  ...
                  dance-offs, this nostalgic “mock sitcom” turns real home videos
                  into heartwarming comedy. No script — just pure, unfiltered
                  Buchler energy.
                </p>

                <div className="flex gap-3">
                  <button className="flex items-center gap-3 bg-white text-black px-6 py-3 rounded-md font-medium shadow hover:scale-105 transition">
                    <svg
                  ...
                  <button className="flex items-center gap-3 bg-gray-700/70 text-white px-5 py-3 rounded-md font-medium hover:bg-gray-600 transition">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
                      viewBox="0 0 20 20"
          ...
          {/* Row of thumbnails */}
          <section className="pb-10 bg-gradient-to-b from-transparent to-black">
